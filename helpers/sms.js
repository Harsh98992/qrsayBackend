...
const sendSMSMessage = async (phoneNumber, otp) => {
    ...
    url = `https://www.fast2sms.com/dev/bulkV2?authorization=XFuBnhTG3jszp4Dda71efbOEZwHrg5WYk0movRiK2LVSU9yCcllbip6VhYMBPfgQFJaGm2KuDt3zr5Uk&route=dlt&sender_id=QRSAYY&message=180398&variables_values=${otp}%7C&flash=0&numbers=${phoneNumber}`;
